                    ...
                    <div class="card">
                        ...
                        <div class="card-footer d-flex bd-highlight w-100 py-1">
                            @if(isset($user->profile->img_path))
                                <img class="rounded-circle mr-1" src="{{ $user->profile->img_path }}" width="30" height="30">
                            @else
                            ...
                            <div class="mr-3 d-flex align-items-center mr-auto">
                                <a href="{{ url('user/users/' .$timeline->user->id) }}" class="text-light mr-1">@if(!empty($user->profile)){{ $user->profile->display_name }}@else{{ $timeline->user->name }}@endif </a>
