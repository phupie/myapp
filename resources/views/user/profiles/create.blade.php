                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('user.profiles.store') }}" enctype="multipart/form-data">
                        ...
                        <div id="input-form" class="form-group">
                            ...
                            <input type="hidden" id="cropImage-head" name="head-img" value="" />
                        </div>
                        ...
                        <div class="form-row pl-1">
                            ...
                            <div class="form-group col-md-8">
                                <div class="form-group">
                                    ...
                                    <input id="display_name" type="text" class="form-control @error('display_name') is-invalid @enderror" name="title" required autocomplete="title" value="{{ old('title') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="job" type="text" class="form-control @error('job') is-invalid @enderror" name="areaName" required autocomplete="area">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="story" type="text" class="form-control @error('story') is-invalid @enderror" name="areaName" required autocomplete="area">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="introduction" type="text" class="form-control @error('introduction') is-invalid @enderror" name="explanation" required autocomplete="explanation" row="4">{{ old('explanation') }}
                            </textarea>
                            @error('introduction')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
